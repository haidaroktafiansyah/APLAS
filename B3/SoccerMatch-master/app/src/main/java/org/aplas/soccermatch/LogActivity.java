...
public class LogActivity extends AppCompatActivity {
    ...
    private void loadLogData() {
        ...
        LogAdapter itemArrayAdapter = new LogAdapter(this,R.layout.layout_log, itemList);
        ...
        for (int i = 0; i < eventList.size(); i++) {
            ...
            if(data[2].equals(findViewById(R.id.awayTeam))){
                winner=getIntent().getStringExtra("AWAY_IMG_URI");
            }else{
                winner=getIntent().getStringExtra("HOME_IMG_URI");
            }
            itemList.add(new LogItem(eventName, eventTime, eventPlayer, winner));
        }
